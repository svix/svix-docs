...
If you have a service that must not be exposed on the public internet that you want to dispatch
webhooks from Svix to, you can deploy a [Svix Bridge] instance inside the same network that
...
[Svix Bridge]: https://github.com/svix/svix-webhooks-private/tree/main/bridge#readme
