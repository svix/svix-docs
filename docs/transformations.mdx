...
- `type` - Choose from a set of services that provide easy webhook integrations, or choose `Custom` to build your own integration. We currently support Slack and Discord.
