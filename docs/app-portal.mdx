...
If you need even more granular control over the look and feel of your App Portal, we also offer a theme configuration JSON object that you can customize to your liking. This gives you and your design team the freedom to tweak font sizes as well as the border radius of different components.

Below is the default theme configuration. To make adjustments, copy a modified version of this theme into the "Custom Theme" textarea on the Organization Settings page of the Svix Dashboard.
