...
import RAW from '!!raw-loader!@site/docs/receiving/verifying-payloads/how-manual.mdx';
import HeaderWithCopyButton from '@site/src/components/HeaderWithCopyButton';

<HeaderWithCopyButton title="Verifying Webhooks Manually" sourceMarkdown={RAW} />
