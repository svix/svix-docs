...
import RAW from '!!raw-loader!@site/docs/receiving/verifying-payloads/how.mdx';
import HeaderWithCopyButton from '@site/src/components/HeaderWithCopyButton';

<HeaderWithCopyButton title="How to Verify Webhooks with the Svix Libraries" sourceMarkdown={RAW} />
