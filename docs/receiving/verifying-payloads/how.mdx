...
This example has been removed since it was not correct. If you are using Fastify
and can contribute a correct example that does not parse and re-stringify the
request payload, we would appreciate a PR against [this file][source].

[source]: https://github.com/svix/svix-docs/blob/main/docs/receiving/verifying-payloads/how.mdx
