---
title: How to Verify Webhooks with Svix
---
...
You should watch out for frameworks that parse the request as JSON and then strigify it because this too will break the signature verification.
