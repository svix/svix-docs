...
If you already have an OpenAPI specification, you can create event types by uploading your API file to Svix. 
...
To automate this process even further, you can also (optionally) add a `x-svix-eventTypeId` property as part of your spec, and we'll automatically use it to set the Svix event type name. 
