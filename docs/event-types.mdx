...
If you use choose the name of an already existing event type, it will be updated with the new values. This is useful to have a predictable mapping of API events to Svix event types.
