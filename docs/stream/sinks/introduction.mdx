...
* [HTTP Endpoints](../sink-types/http)
* [OpenTelemetry Trace Collector](../sink-types/otel_trace)
* [Amazon S3](../sink-types/s3)
* [Google Cloud Storage](../sink-types/gcs)
* [Azure Blob Storage](../sink-types/azure_blob)
* [Polling Endpoint](../sink-types/poller)
