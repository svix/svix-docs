...
On your service, return the the Svix application ID and integration secret to your user. See the [Integration section](http://api.svix.com/docs#tag/Integration) of the API docs for more information.
...
appOut, err := svixClient.Application.Create(&svix.ApplicationIn{
    Name: "Test Application",
})}
integOut, err := svixClient.Integration.Create(appOut.Id, &svix.IntegrationIn{
    Name: "Zapier Integration",
})
integKeyOut, err := svixClient.Integration.GetKey(appOut.Id, integOut.Id)
```
