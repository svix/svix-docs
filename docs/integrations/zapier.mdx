...
Finally, try it out! From the account where you deployed the integration, you can create a Zap and test the integration. It will not be publicly available on the Zapier website until it's released, but you can share the integration with your users.
