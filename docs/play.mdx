...
You can use the [Svix Play webhook playground and tester](https://www.svix.com/play/) to easily inspect, test and debug incoming webhooks.
...
In relay mode, you can use the Svix CLI for a free and secure public URL that relays requests to your local development server. All of these requests are then viewable in the [Svix Play webhook tester](https://www.svix.com/play/) UI.
