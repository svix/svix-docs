...
Are you looking for docs about how to receive webhooks sent by Svix? Please refer to the [receiving webhooks](./receiving/introduction.mdx) section of the docs.
