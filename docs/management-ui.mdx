...
![Application portal screenshot](./img/attempts.png)
...
![Embedded application portal screenshot](./img/embedded-management-ui.png)
...
The npm package is lightweight and provides some basic styling and a loading indicator out of the box. For a more complete usage example, check out the [package README](https://www.npmjs.com/package/svix-react).
