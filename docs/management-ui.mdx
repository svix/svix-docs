...
The returned URL from the previous section can also be embedded in your own dashboard using an iframe. This is how it looks like:

<img alt="Embedded Management UI screenshot" src={useBaseUrl("img/embedded-management-ui.png")} />

To do it, just set the url from the examples above in the `src` property of the iframe:
