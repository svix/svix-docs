...
The management UI automatically can be customized to follow your UI's look and feel. We currently support customizing the color palette as well as the logo used.
