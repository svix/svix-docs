...
Development and Production environments behave almost exactly the same. The main difference is the associated tag and the visual indicator, as well as some other minor differences.
