...
### <ConnectorLogo name="slack" /> Slack
...
### <ConnectorLogo name="discord" /> Discord
...
### <ConnectorLogo name="microsoft-teams" /> Microsoft Teams
...
### <ConnectorLogo name="hubspot" /> Hubspot
...
### <ConnectorLogo name="windmill" /> Windmill
...
### <ConnectorLogo name="sendgrid" /> Sendgrid
...
### <ConnectorLogo name="resend" /> Resend
...
### <ConnectorLogo name="loops" /> Loops
