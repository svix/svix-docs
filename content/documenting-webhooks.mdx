...
Here is an example from one of our customers, Brex: [https://developer.brex.com/guides/webhooks](https://developer.brex.com/guides/webhooks)
...
You can take a look at [Brex's docs](https://developer.brex.com/guides/webhooks) again for an example of the event catalog.
...
```plaintext filename="Adding an Endpoint"
...
```plaintext filename="Testing Endpoints"
...
```plaintext filename="Verifying Signatures"
...
```javascript filename="Javascript Code Sample"
...
```plaintext filename="Retry Schedule"
Retries
...
```plaintext filename="Troubleshooting Tips"
...
```plaintext filename="Failure Recovery"
