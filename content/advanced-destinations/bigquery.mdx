...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use a BigQuery destination in the [App Portal](/app-portal).

![BigQuery Endpoint Create](/img/advanced-destinations/bigquery-create.png)
