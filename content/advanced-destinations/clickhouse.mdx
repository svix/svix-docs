...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use a ClickHouse destination in the [App Portal](/app-portal).

![ClickHouse Endpoint Create](/img/advanced-destinations/clickhouse-create.png)
