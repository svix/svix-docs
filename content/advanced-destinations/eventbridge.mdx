...
When **Advanced Destinations** is [enabled](/advanced-endpoints#enabling-advanced-destinations), your customers will see the option to use an EventBridge destination in the [App Portal](/app-portal).
