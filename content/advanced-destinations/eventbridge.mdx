...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use an EventBridge destination in the [App Portal](/app-portal).

![EventBridge Endpoint Create](/img/advanced-destinations/eventbridge-create.png)
