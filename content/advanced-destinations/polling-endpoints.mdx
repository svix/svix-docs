...
Polling Endpoints can be enabled at the environment level in the [Svix Dashboard](https://dashboard.svix.com/settings/organization/general-settings) by enabling **Advanced Destinations**.

![Enable Polling Endpoints](/img/advanced-destinations/advanced-destinations-setting.png)

When you enable Polling Endpoints, your users will be able to create them in the [App Portal](/app-portal).

![Polling Endpoint Create](/img/advanced-destinations/polling-endpoint-create.png)
