...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use an SNS destination in the [App Portal](/app-portal).

![SNS Endpoint Create](/img/advanced-destinations/sns-create.png)
