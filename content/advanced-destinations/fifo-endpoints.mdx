...
**Why not make all webhooks FIFO?**
...
FIFO Endpoints can be enabled at the environment level in the [Svix Dashboard](https://dashboard.svix.com/settings/organization/general-settings) by enabling **Advanced Destinations**.

![Enable FIFO Endpoints](/img/advanced-destinations/advanced-destinations-setting.png)


When you enable FIFO Endpoints, your users will be able to create them in the [App Portal](/app-portal).

![Polling Endpoint Create](/img/advanced-destinations/fifo-endpoint-create.png)
...
![FIFO Endpoint Batching](/img/advanced-destinations/fifo-endpoint-batching.png)
