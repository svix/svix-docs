...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use a Snowflake destination in the [App Portal](/app-portal).

![Snowflake Endpoint Create](/img/advanced-destinations/snowflake-create.png)
