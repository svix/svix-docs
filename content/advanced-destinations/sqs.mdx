...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use an SQS destination in the [App Portal](/app-portal).

![SQS Endpoint Create](/img/advanced-destinations/sqs-create.png)
