...
When **Advanced Destinations** is [enabled](/advanced-destinations#enabling-advanced-destinations), your customers will see the option to use a Redshift destination in the [App Portal](/app-portal).

![Redshift Endpoint Create](/img/advanced-destinations/redshift-create.png)
