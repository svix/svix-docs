...
import RAW from '!!raw-loader!@site/docs/integrations/advanced-zapier.mdx';
import HeaderWithCopyButton from '@site/src/components/HeaderWithCopyButton';

<HeaderWithCopyButton title="Advanced Zapier Integrations" sourceMarkdown={RAW} />
...
The default scheme might be undesirable because it requires the user to copy-paste credentials and doesn't connect to your existing auth flows.
