...
Retries will be stopped if the receiving end includes the header `webhook-delivery: abort-message` in its response (see also [Delivery Control](/receiving/delivery-control.mdx)).
